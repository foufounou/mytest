...
# Project:  mytest.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile mytest.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++17 -lstdc++fs -std=c++17 -Wall -Wextra -D_REENTRANT -fPIC $(DEFINES)
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = mytest1.0.0
DISTDIR = /home/szinedine/labo/mytest/.tmp/mytest1.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: mytest.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++17 -lstdc++fs -std=c++17 -Wall -Wextra -dM -E -o moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/mytest/bin || mkdir -p $(INSTALL_ROOT)/opt/mytest/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/mytest/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/mytest/bin/$(QMAKE_TARGET)
